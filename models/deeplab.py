...
def run_visualization(model, original_im):
...
if __name__ == "__main__":
    ...
    download_path = os.path.join(save_path, _TARBALL_NAME)
    ...
    im_path = '/opt/datasets/cityscapes/leftImg8bit/test/berlin/berlin_000001_000019_leftImg8bit.png'
    original_im = Image.open(im_path)
    run_visualization(model, original_im)